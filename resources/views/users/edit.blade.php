        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    Edit User Form
                    <span class="float-end"><a href="{{ route('users.index') }}" class="text-decoration-none">Back</a></span>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update',$user->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname',$user->firstname) }}" required autocomplete="name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" placeholder="Enter New Password If You Want"class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
