                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employees.update',$employee->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control @error('name') is-invalid @enderror" name="firstname" value="{{ old('firstname',$employee->firstname) }}" required autocomplete="firstname">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="middlename" type="text" class="form-control @error('middlename') is-invalid @enderror" name="middlename" value="{{ old('middlename',$employee->middlename) }}" required autocomplete="middlename">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname',$employee->lastname) }}" required autocomplete="lastname">
                                    ...
                                    @foreach ($States as $state)
                                        @if ($state->id == $employee->state_id)
                                            ...
                                            @foreach ($States as $st)
                                                @if ($st->country_id == $state->country_id)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="zip_code" type="text" class="form-control @error('zip_code') is-invalid @enderror" name="zip_code" value="{{ old('zip_code',$employee->zip_code) }}" required autocomplete="zip_code">
                                @error('zip_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="date_hired" type="date" class="form-control @error('date_hired') is-invalid @enderror" name="date_hired" value="{{ old('date_hired',$employee->date_hired) }}" required autocomplete="date_hired">
                                @error('date_hired')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
